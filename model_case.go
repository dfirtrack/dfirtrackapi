...
type Case struct {
	...
	CaseAssignedToUserId NullableInt32 `json:"case_assigned_to_user_id,omitempty"`
}
...
// GetCaseAssignedToUserId returns the CaseAssignedToUserId field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *Case) GetCaseAssignedToUserId() int32 {
	if o == nil || o.CaseAssignedToUserId.Get() == nil {
		var ret int32
		return ret
	}
	return *o.CaseAssignedToUserId.Get()
}

// GetCaseAssignedToUserIdOk returns a tuple with the CaseAssignedToUserId field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
...
// SetCaseAssignedToUserId gets a reference to the given NullableInt32 and assigns it to the CaseAssignedToUserId field.
func (o *Case) SetCaseAssignedToUserId(v int32) {
	o.CaseAssignedToUserId.Set(&v)
}
// SetCaseAssignedToUserIdNil sets the value for CaseAssignedToUserId to be an explicit nil
func (o *Case) SetCaseAssignedToUserIdNil() {
	o.CaseAssignedToUserId.Set(nil)
}
...
func (o Case) MarshalJSON() ([]byte, error) {
	...
	if o.CaseAssignedToUserId.IsSet() {
		toSerialize["case_assigned_to_user_id"] = o.CaseAssignedToUserId.Get()
	}

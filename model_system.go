...
type System struct {
	...
	SystemAssignedToUserId NullableInt32 `json:"system_assigned_to_user_id,omitempty"`
...
func (o *System) GetSystemModifyTime() time.Time {
	if o == nil || o.SystemModifyTime == nil {
		var ret time.Time
		return ret
	}
...
// GetSystemModifyTimeOk returns a tuple with the SystemModifyTime field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// GetSystemAssignedToUserId returns the SystemAssignedToUserId field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *System) GetSystemAssignedToUserId() int32 {
	if o == nil || o.SystemAssignedToUserId.Get() == nil {
		var ret int32
		return ret
	}
	return *o.SystemAssignedToUserId.Get()
}

// GetSystemAssignedToUserIdOk returns a tuple with the SystemAssignedToUserId field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
...
// SetSystemAssignedToUserId gets a reference to the given NullableInt32 and assigns it to the SystemAssignedToUserId field.
func (o *System) SetSystemAssignedToUserId(v int32) {
	o.SystemAssignedToUserId.Set(&v)
}
// SetSystemAssignedToUserIdNil sets the value for SystemAssignedToUserId to be an explicit nil
func (o *System) SetSystemAssignedToUserIdNil() {
	o.SystemAssignedToUserId.Set(nil)
}
...
func (o *System) UnsetSystemAssignedToUserId() {
	o.SystemAssignedToUserId.Unset()
}
...
func (o System) MarshalJSON() ([]byte, error) {
	...
	if o.SystemModifyTime != nil {
		toSerialize["system_modify_time"] = o.SystemModifyTime
	}
	if true {
		toSerialize["system_modified_by_user_id"] = o.SystemModifiedByUserId
	}
	if o.SystemAssignedToUserId.IsSet() {
		toSerialize["system_assigned_to_user_id"] = o.SystemAssignedToUserId.Get()
	}

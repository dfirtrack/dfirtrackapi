...
func (r ApiCreateAuthTokenRequest) Execute() (AuthToken, *_nethttp.Response, error) {
...
func (r ApiCreateCasetypeRequest) Execute() (Casetype, *_nethttp.Response, error) {
...
func (r ApiCreateHeadlineRequest) Execute() (Headline, *_nethttp.Response, error) {
 ...
 */
func (a *ApiApiService) CreateNote(ctx _context.Context) ApiCreateNoteRequest {
	return ApiCreateNoteRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (r ApiCreateReportitemRequest) Execute() (Reportitem, *_nethttp.Response, error) {
...
func (r ApiListArtifactprioritysRequest) Execute() ([]Artifactpriority, *_nethttp.Response, error) {
...
func (r ApiListCaseprioritysRequest) Execute() ([]Casepriority, *_nethttp.Response, error) {
...
func (r ApiListCasestatusRequest) Execute() ([]Casestatus, *_nethttp.Response, error) {
...
func (r ApiListCasetypesRequest) Execute() ([]Casetype, *_nethttp.Response, error) {
...
func (r ApiListHeadlinesRequest) Execute() ([]Headline, *_nethttp.Response, error) {
 ...
 */
func (a *ApiApiService) ListNotes(ctx _context.Context) ApiListNotesRequest {
	return ApiListNotesRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (r ApiListNotestatusRequest) Execute() ([]Notestatus, *_nethttp.Response, error) {
...
func (r ApiListReportitemsRequest) Execute() ([]Reportitem, *_nethttp.Response, error) {
...
func (r ApiPartialUpdateCasetypeRequest) Execute() (Casetype, *_nethttp.Response, error) {
...
func (a *ApiApiService) PartialUpdateCasetypeExecute(r ApiPartialUpdateCasetypeRequest) (Casetype, *_nethttp.Response, error) {
	...
	localVarPath = strings.Replace(localVarPath, "{"+"casetype_id"+"}", _neturl.PathEscape(parameterToString(r.casetypeId, "")), -1)
...
func (r ApiPartialUpdateHeadlineRequest) Execute() (Headline, *_nethttp.Response, error) {
...
func (a *ApiApiService) PartialUpdateHeadlineExecute(r ApiPartialUpdateHeadlineRequest) (Headline, *_nethttp.Response, error) {
	...
	localVarPath = strings.Replace(localVarPath, "{"+"headline_id"+"}", _neturl.PathEscape(parameterToString(r.headlineId, "")), -1)
...
func (r ApiPartialUpdateNoteRequest) Execute() (Note, *_nethttp.Response, error) {
...
func (a *ApiApiService) PartialUpdateNoteExecute(r ApiPartialUpdateNoteRequest) (Note, *_nethttp.Response, error) {
	...
	localVarPath = strings.Replace(localVarPath, "{"+"note_id"+"}", _neturl.PathEscape(parameterToString(r.noteId, "")), -1)
...
func (r ApiPartialUpdateReportitemRequest) Execute() (Reportitem, *_nethttp.Response, error) {
...
func (a *ApiApiService) PartialUpdateReportitemExecute(r ApiPartialUpdateReportitemRequest) (Reportitem, *_nethttp.Response, error) {
	...
	localVarPath = strings.Replace(localVarPath, "{"+"reportitem_id"+"}", _neturl.PathEscape(parameterToString(r.reportitemId, "")), -1)
...
func (r ApiRetrieveArtifactpriorityRequest) Execute() (Artifactpriority, *_nethttp.Response, error) {
...
func (a *ApiApiService) RetrieveArtifactpriorityExecute(r ApiRetrieveArtifactpriorityRequest) (Artifactpriority, *_nethttp.Response, error) {
	...
	localVarPath = strings.Replace(localVarPath, "{"+"artifactpriority_id"+"}", _neturl.PathEscape(parameterToString(r.artifactpriorityId, "")), -1)
...
func (r ApiRetrieveCasepriorityRequest) Execute() (Casepriority, *_nethttp.Response, error) {
...
func (a *ApiApiService) RetrieveCasepriorityExecute(r ApiRetrieveCasepriorityRequest) (Casepriority, *_nethttp.Response, error) {
	...
	localVarPath = strings.Replace(localVarPath, "{"+"casepriority_id"+"}", _neturl.PathEscape(parameterToString(r.casepriorityId, "")), -1)
...
func (r ApiRetrieveCasestatusRequest) Execute() (Casestatus, *_nethttp.Response, error) {
...
func (a *ApiApiService) RetrieveCasestatusExecute(r ApiRetrieveCasestatusRequest) (Casestatus, *_nethttp.Response, error) {
	...
	localVarPath = strings.Replace(localVarPath, "{"+"casestatus_id"+"}", _neturl.PathEscape(parameterToString(r.casestatusId, "")), -1)
...
func (r ApiRetrieveCasetypeRequest) Execute() (Casetype, *_nethttp.Response, error) {
...
func (r ApiRetrieveHeadlineRequest) Execute() (Headline, *_nethttp.Response, error) {
...
func (r ApiRetrieveNoteRequest) Execute() (Note, *_nethttp.Response, error) {
...
func (r ApiRetrieveNotestatusRequest) Execute() (Notestatus, *_nethttp.Response, error) {
...
func (a *ApiApiService) RetrieveNotestatusExecute(r ApiRetrieveNotestatusRequest) (Notestatus, *_nethttp.Response, error) {
	...
	localVarPath = strings.Replace(localVarPath, "{"+"notestatus_id"+"}", _neturl.PathEscape(parameterToString(r.notestatusId, "")), -1)
...
func (r ApiRetrieveReportitemRequest) Execute() (Reportitem, *_nethttp.Response, error) {
...
func (r ApiUpdateCasetypeRequest) Execute() (Casetype, *_nethttp.Response, error) {
...
func (r ApiUpdateHeadlineRequest) Execute() (Headline, *_nethttp.Response, error) {
...
func (r ApiUpdateReportitemRequest) Execute() (Reportitem, *_nethttp.Response, error) {

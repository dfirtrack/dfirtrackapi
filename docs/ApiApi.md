...
------------- | ------------- | -------------
[**CreateArtifact**](ApiApi.md#CreateArtifact) | **Post** /api/artifact/ | 
...
[**CreateSystemuser**](ApiApi.md#CreateSystemuser) | **Post** /api/systemuser/ | 
[**CreateTag**](ApiApi.md#CreateTag) | **Post** /api/tag/ | 
...
[**ListSystemtypes**](ApiApi.md#ListSystemtypes) | **Get** /api/systemtype/ | 
[**ListSystemusers**](ApiApi.md#ListSystemusers) | **Get** /api/systemuser/ | 
[**ListTagcolors**](ApiApi.md#ListTagcolors) | **Get** /api/tagcolor/ | 
...
func main() {
    system := *openapiclient.NewSystem("SystemName_example", int32(123), int32(123), "TODO", int32(123)) // System |  (optional)
...
func main() {
    ...
    // response from `PartialUpdateArtifacttype`: Artifacttype
    fmt.Fprintf(os.Stdout, "Response from `ApiApi.PartialUpdateArtifacttype`: %v\n", resp)
}
```
...
------------- | ------------- | ------------- | -------------
**ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
**artifacttypeId** | **string** | A unique integer value identifying this artifacttype. | 

### Other Parameters

Other parameters are passed through a pointer to a apiPartialUpdateArtifacttypeRequest struct via the builder pattern
...
> Case PartialUpdateCase(ctx, caseId).Case_(case_).Execute()
...
func main() {
    ...
    // response from `PartialUpdateCase`: Case
    fmt.Fprintf(os.Stdout, "Response from `ApiApi.PartialUpdateCase`: %v\n", resp)
}
```
...
------------- | ------------- | ------------- | -------------
**ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
**caseId** | **string** | A unique integer value identifying this case. | 

### Other Parameters

Other parameters are passed through a pointer to a apiPartialUpdateCaseRequest struct via the builder pattern
...
func main() {
    ...
    // response from `PartialUpdateCompany`: Company
    fmt.Fprintf(os.Stdout, "Response from `ApiApi.PartialUpdateCompany`: %v\n", resp)
}
```
...
------------- | ------------- | ------------- | -------------
**ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
**companyId** | **string** | A unique integer value identifying this company. | 

### Other Parameters

Other parameters are passed through a pointer to a apiPartialUpdateCompanyRequest struct via the builder pattern
...
> Contact PartialUpdateContact(ctx, contactId).Contact(contact).Execute()
...
func main() {
    ...
    // response from `PartialUpdateContact`: Contact
    fmt.Fprintf(os.Stdout, "Response from `ApiApi.PartialUpdateContact`: %v\n", resp)
}
```
...
------------- | ------------- | ------------- | -------------
**ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
**contactId** | **string** | A unique integer value identifying this contact. | 

### Other Parameters

Other parameters are passed through a pointer to a apiPartialUpdateContactRequest struct via the builder pattern
...
> Division PartialUpdateDivision(ctx, divisionId).Division(division).Execute()
...
func main() {
    ...
    // response from `PartialUpdateDivision`: Division
    fmt.Fprintf(os.Stdout, "Response from `ApiApi.PartialUpdateDivision`: %v\n", resp)
}
```
...
------------- | ------------- | ------------- | -------------
**ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
**divisionId** | **string** | A unique integer value identifying this division. | 

### Other Parameters

Other parameters are passed through a pointer to a apiPartialUpdateDivisionRequest struct via the builder pattern
...
## PartialUpdateDnsname

> Dnsname PartialUpdateDnsname(ctx, dnsnameId).Dnsname(dnsname).Execute()
...
func main() {
    ...
    // response from `PartialUpdateDnsname`: Dnsname
    fmt.Fprintf(os.Stdout, "Response from `ApiApi.PartialUpdateDnsname`: %v\n", resp)
}
```
...
------------- | ------------- | ------------- | -------------
**ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
**dnsnameId** | **string** | A unique integer value identifying this dnsname. | 

### Other Parameters

Other parameters are passed through a pointer to a apiPartialUpdateDnsnameRequest struct via the builder pattern
...
> Domain PartialUpdateDomain(ctx, domainId).Domain(domain).Execute()
...
func main() {
    ...
    // response from `PartialUpdateDomain`: Domain
    fmt.Fprintf(os.Stdout, "Response from `ApiApi.PartialUpdateDomain`: %v\n", resp)
}
```
...
------------- | ------------- | ------------- | -------------
**ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
**domainId** | **string** | A unique integer value identifying this domain. | 

### Other Parameters

Other parameters are passed through a pointer to a apiPartialUpdateDomainRequest struct via the builder pattern
...
> Domainuser PartialUpdateDomainuser(ctx, domainuserId).Domainuser(domainuser).Execute()
...
func main() {
    ...
    // response from `PartialUpdateDomainuser`: Domainuser
    fmt.Fprintf(os.Stdout, "Response from `ApiApi.PartialUpdateDomainuser`: %v\n", resp)
}
```
...
------------- | ------------- | ------------- | -------------
**ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
**domainuserId** | **string** | A unique integer value identifying this domainuser. | 

### Other Parameters

Other parameters are passed through a pointer to a apiPartialUpdateDomainuserRequest struct via the builder pattern
...
func main() {
    ...
    // response from `PartialUpdateIp`: Ip
    fmt.Fprintf(os.Stdout, "Response from `ApiApi.PartialUpdateIp`: %v\n", resp)
}
```
...
------------- | ------------- | ------------- | -------------
**ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
**ipId** | **string** | A unique integer value identifying this ip. | 

### Other Parameters

Other parameters are passed through a pointer to a apiPartialUpdateIpRequest struct via the builder pattern
...
> Location PartialUpdateLocation(ctx, locationId).Location(location).Execute()
...
func main() {
    ...
    // response from `PartialUpdateLocation`: Location
    fmt.Fprintf(os.Stdout, "Response from `ApiApi.PartialUpdateLocation`: %v\n", resp)
}
```
...
------------- | ------------- | ------------- | -------------
**ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
**locationId** | **string** | A unique integer value identifying this location. | 

### Other Parameters

Other parameters are passed through a pointer to a apiPartialUpdateLocationRequest struct via the builder pattern
...
> Os PartialUpdateOs(ctx, osId).Os(os).Execute()
...
func main() {
    ...
    // response from `PartialUpdateOs`: Os
    fmt.Fprintf(os.Stdout, "Response from `ApiApi.PartialUpdateOs`: %v\n", resp)
}
```
...
------------- | ------------- | ------------- | -------------
**ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
**osId** | **string** | A unique integer value identifying this os. | 

### Other Parameters

Other parameters are passed through a pointer to a apiPartialUpdateOsRequest struct via the builder pattern
...
> Osarch PartialUpdateOsarch(ctx, osarchId).Osarch(osarch).Execute()
...
func main() {
    ...
    // response from `PartialUpdateOsarch`: Osarch
    fmt.Fprintf(os.Stdout, "Response from `ApiApi.PartialUpdateOsarch`: %v\n", resp)
}
```
...
------------- | ------------- | ------------- | -------------
**ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
**osarchId** | **string** | A unique integer value identifying this osarch. | 

### Other Parameters

Other parameters are passed through a pointer to a apiPartialUpdateOsarchRequest struct via the builder pattern
...
> Reason PartialUpdateReason(ctx, reasonId).Reason(reason).Execute()
...
func main() {
    ...
    // response from `PartialUpdateReason`: Reason
    fmt.Fprintf(os.Stdout, "Response from `ApiApi.PartialUpdateReason`: %v\n", resp)
}
```
...
------------- | ------------- | ------------- | -------------
**ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
**reasonId** | **string** | A unique integer value identifying this reason. | 

### Other Parameters

Other parameters are passed through a pointer to a apiPartialUpdateReasonRequest struct via the builder pattern
...
## PartialUpdateRecommendation

> Recommendation PartialUpdateRecommendation(ctx, recommendationId).Recommendation(recommendation).Execute()
...
func main() {
    ...
    // response from `PartialUpdateRecommendation`: Recommendation
    fmt.Fprintf(os.Stdout, "Response from `ApiApi.PartialUpdateRecommendation`: %v\n", resp)
}
```
...
------------- | ------------- | ------------- | -------------
**ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
**recommendationId** | **string** | A unique integer value identifying this recommendation. | 

### Other Parameters

Other parameters are passed through a pointer to a apiPartialUpdateRecommendationRequest struct via the builder pattern
...
## PartialUpdateServiceprovider

> Serviceprovider PartialUpdateServiceprovider(ctx, serviceproviderId).Serviceprovider(serviceprovider).Execute()
...
func main() {
    ...
    // response from `PartialUpdateServiceprovider`: Serviceprovider
    fmt.Fprintf(os.Stdout, "Response from `ApiApi.PartialUpdateServiceprovider`: %v\n", resp)
}
```
...
------------- | ------------- | ------------- | -------------
**ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
**serviceproviderId** | **string** | A unique integer value identifying this serviceprovider. | 

### Other Parameters

Other parameters are passed through a pointer to a apiPartialUpdateServiceproviderRequest struct via the builder pattern
...
> System PartialUpdateSystem(ctx, systemId).System(system).Execute()
...
func main() {
    ...
    // response from `PartialUpdateSystem`: System
    fmt.Fprintf(os.Stdout, "Response from `ApiApi.PartialUpdateSystem`: %v\n", resp)
}
```
...
------------- | ------------- | ------------- | -------------
**ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
**systemId** | **string** | A unique integer value identifying this system. | 

### Other Parameters

Other parameters are passed through a pointer to a apiPartialUpdateSystemRequest struct via the builder pattern
...
## PartialUpdateSystemtype

> Systemtype PartialUpdateSystemtype(ctx, systemtypeId).Systemtype(systemtype).Execute()
...
func main() {
    ...
    // response from `PartialUpdateSystemtype`: Systemtype
    fmt.Fprintf(os.Stdout, "Response from `ApiApi.PartialUpdateSystemtype`: %v\n", resp)
}
```
...
------------- | ------------- | ------------- | -------------
**ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
**systemtypeId** | **string** | A unique integer value identifying this systemtype. | 

### Other Parameters

Other parameters are passed through a pointer to a apiPartialUpdateSystemtypeRequest struct via the builder pattern
...
## PartialUpdateSystemuser

> Systemuser PartialUpdateSystemuser(ctx, systemuserId).Systemuser(systemuser).Execute()
...
func main() {
    ...
    // response from `PartialUpdateSystemuser`: Systemuser
    fmt.Fprintf(os.Stdout, "Response from `ApiApi.PartialUpdateSystemuser`: %v\n", resp)
}
```
...
------------- | ------------- | ------------- | -------------
**ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
**systemuserId** | **string** | A unique integer value identifying this systemuser. | 

### Other Parameters

Other parameters are passed through a pointer to a apiPartialUpdateSystemuserRequest struct via the builder pattern
...
> Tag PartialUpdateTag(ctx, tagId).Tag(tag).Execute()
...
func main() {
    ...
    // response from `PartialUpdateTag`: Tag
    fmt.Fprintf(os.Stdout, "Response from `ApiApi.PartialUpdateTag`: %v\n", resp)
}
```
...
------------- | ------------- | ------------- | -------------
**ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
**tagId** | **string** | A unique integer value identifying this tag. | 

### Other Parameters

Other parameters are passed through a pointer to a apiPartialUpdateTagRequest struct via the builder pattern
...
> Task PartialUpdateTask(ctx, taskId).Task(task).Execute()
...
func main() {
    ...
    // response from `PartialUpdateTask`: Task
    fmt.Fprintf(os.Stdout, "Response from `ApiApi.PartialUpdateTask`: %v\n", resp)
}
```
...
------------- | ------------- | ------------- | -------------
**ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
**taskId** | **string** | A unique integer value identifying this task. | 

### Other Parameters

Other parameters are passed through a pointer to a apiPartialUpdateTaskRequest struct via the builder pattern
...
## PartialUpdateTaskname

> Taskname PartialUpdateTaskname(ctx, tasknameId).Taskname(taskname).Execute()
...
func main() {
    ...
    // response from `PartialUpdateTaskname`: Taskname
    fmt.Fprintf(os.Stdout, "Response from `ApiApi.PartialUpdateTaskname`: %v\n", resp)
}
```
...
------------- | ------------- | ------------- | -------------
**ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
**tasknameId** | **string** | A unique integer value identifying this taskname. | 

### Other Parameters

Other parameters are passed through a pointer to a apiPartialUpdateTasknameRequest struct via the builder pattern
...
> Analysisstatus RetrieveAnalysisstatus(ctx, analysisstatusId).Execute()
...
func main() {
    ...
    // response from `RetrieveAnalysisstatus`: Analysisstatus
    fmt.Fprintf(os.Stdout, "Response from `ApiApi.RetrieveAnalysisstatus`: %v\n", resp)
}
```
...
------------- | ------------- | ------------- | -------------
**ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
**analysisstatusId** | **string** | A unique integer value identifying this analysisstatus. | 

### Other Parameters

Other parameters are passed through a pointer to a apiRetrieveAnalysisstatusRequest struct via the builder pattern
...
> Artifact RetrieveArtifact(ctx, artifactId).Execute()
...
func main() {
    ...
    // response from `RetrieveArtifact`: Artifact
    fmt.Fprintf(os.Stdout, "Response from `ApiApi.RetrieveArtifact`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiRetrieveArtifactRequest struct via the builder pattern
...
func main() {
    ...
    // response from `RetrieveArtifactstatus`: Artifactstatus
    fmt.Fprintf(os.Stdout, "Response from `ApiApi.RetrieveArtifactstatus`: %v\n", resp)
}
```
...
------------- | ------------- | ------------- | -------------
**ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
**artifactstatusId** | **string** | A unique integer value identifying this artifactstatus. | 

### Other Parameters

Other parameters are passed through a pointer to a apiRetrieveArtifactstatusRequest struct via the builder pattern
...
> Artifacttype RetrieveArtifacttype(ctx, artifacttypeId).Execute()
...
func main() {
    ...
    // response from `RetrieveArtifacttype`: Artifacttype
    fmt.Fprintf(os.Stdout, "Response from `ApiApi.RetrieveArtifacttype`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiRetrieveArtifacttypeRequest struct via the builder pattern
...
> Case RetrieveCase(ctx, caseId).Execute()
...
func main() {
    ...
    // response from `RetrieveCase`: Case
    fmt.Fprintf(os.Stdout, "Response from `ApiApi.RetrieveCase`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiRetrieveCaseRequest struct via the builder pattern
...
> Company RetrieveCompany(ctx, companyId).Execute()
...
func main() {
    ...
    // response from `RetrieveCompany`: Company
    fmt.Fprintf(os.Stdout, "Response from `ApiApi.RetrieveCompany`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiRetrieveCompanyRequest struct via the builder pattern
...
> Contact RetrieveContact(ctx, contactId).Execute()
...
func main() {
    ...
    // response from `RetrieveContact`: Contact
    fmt.Fprintf(os.Stdout, "Response from `ApiApi.RetrieveContact`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiRetrieveContactRequest struct via the builder pattern
...
> Division RetrieveDivision(ctx, divisionId).Execute()
...
func main() {
    ...
    // response from `RetrieveDivision`: Division
    fmt.Fprintf(os.Stdout, "Response from `ApiApi.RetrieveDivision`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiRetrieveDivisionRequest struct via the builder pattern
...
> Dnsname RetrieveDnsname(ctx, dnsnameId).Execute()
...
func main() {
    ...
    // response from `RetrieveDnsname`: Dnsname
    fmt.Fprintf(os.Stdout, "Response from `ApiApi.RetrieveDnsname`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiRetrieveDnsnameRequest struct via the builder pattern
...
> Domain RetrieveDomain(ctx, domainId).Execute()
...
func main() {
    ...
    // response from `RetrieveDomain`: Domain
    fmt.Fprintf(os.Stdout, "Response from `ApiApi.RetrieveDomain`: %v\n", resp)
}
```
...
> Domainuser RetrieveDomainuser(ctx, domainuserId).Execute()
...
func main() {
    ...
    // response from `RetrieveDomainuser`: Domainuser
    fmt.Fprintf(os.Stdout, "Response from `ApiApi.RetrieveDomainuser`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiRetrieveDomainuserRequest struct via the builder pattern
...
func main() {
    ...
    // response from `RetrieveIp`: Ip
    fmt.Fprintf(os.Stdout, "Response from `ApiApi.RetrieveIp`: %v\n", resp)
}
```
...
> Location RetrieveLocation(ctx, locationId).Execute()
...
func main() {
    ...
    // response from `RetrieveLocation`: Location
    fmt.Fprintf(os.Stdout, "Response from `ApiApi.RetrieveLocation`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiRetrieveLocationRequest struct via the builder pattern
...
> Os RetrieveOs(ctx, osId).Execute()
...
func main() {
    ...
    // response from `RetrieveOs`: Os
    fmt.Fprintf(os.Stdout, "Response from `ApiApi.RetrieveOs`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiRetrieveOsRequest struct via the builder pattern
...
> Osarch RetrieveOsarch(ctx, osarchId).Execute()
...
func main() {
    ...
    // response from `RetrieveOsarch`: Osarch
    fmt.Fprintf(os.Stdout, "Response from `ApiApi.RetrieveOsarch`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiRetrieveOsarchRequest struct via the builder pattern
...
> Reason RetrieveReason(ctx, reasonId).Execute()
...
func main() {
    ...
    // response from `RetrieveReason`: Reason
    fmt.Fprintf(os.Stdout, "Response from `ApiApi.RetrieveReason`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiRetrieveReasonRequest struct via the builder pattern
...
> Recommendation RetrieveRecommendation(ctx, recommendationId).Execute()
...
func main() {
    ...
    // response from `RetrieveRecommendation`: Recommendation
    fmt.Fprintf(os.Stdout, "Response from `ApiApi.RetrieveRecommendation`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiRetrieveRecommendationRequest struct via the builder pattern
...
> Serviceprovider RetrieveServiceprovider(ctx, serviceproviderId).Execute()
...
func main() {
    ...
    // response from `RetrieveServiceprovider`: Serviceprovider
    fmt.Fprintf(os.Stdout, "Response from `ApiApi.RetrieveServiceprovider`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiRetrieveServiceproviderRequest struct via the builder pattern
...
> System RetrieveSystem(ctx, systemId).Execute()
...
func main() {
    ...
    // response from `RetrieveSystem`: System
    fmt.Fprintf(os.Stdout, "Response from `ApiApi.RetrieveSystem`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiRetrieveSystemRequest struct via the builder pattern
...
> Systemstatus RetrieveSystemstatus(ctx, systemstatusId).Execute()
...
func main() {
    ...
    // response from `RetrieveSystemstatus`: Systemstatus
    fmt.Fprintf(os.Stdout, "Response from `ApiApi.RetrieveSystemstatus`: %v\n", resp)
}
```
...
------------- | ------------- | ------------- | -------------
**ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
**systemstatusId** | **string** | A unique integer value identifying this systemstatus. | 

### Other Parameters

Other parameters are passed through a pointer to a apiRetrieveSystemstatusRequest struct via the builder pattern
...
> Systemtype RetrieveSystemtype(ctx, systemtypeId).Execute()
...
func main() {
    ...
    // response from `RetrieveSystemtype`: Systemtype
    fmt.Fprintf(os.Stdout, "Response from `ApiApi.RetrieveSystemtype`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiRetrieveSystemtypeRequest struct via the builder pattern
...
> Systemuser RetrieveSystemuser(ctx, systemuserId).Execute()
...
func main() {
    ...
    // response from `RetrieveSystemuser`: Systemuser
    fmt.Fprintf(os.Stdout, "Response from `ApiApi.RetrieveSystemuser`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiRetrieveSystemuserRequest struct via the builder pattern
...
> Tag RetrieveTag(ctx, tagId).Execute()
...
func main() {
    ...
    // response from `RetrieveTag`: Tag
    fmt.Fprintf(os.Stdout, "Response from `ApiApi.RetrieveTag`: %v\n", resp)
}
```
...
> Tagcolor RetrieveTagcolor(ctx, tagcolorId).Execute()
...
func main() {
    ...
    // response from `RetrieveTagcolor`: Tagcolor
    fmt.Fprintf(os.Stdout, "Response from `ApiApi.RetrieveTagcolor`: %v\n", resp)
}
```
...
------------- | ------------- | ------------- | -------------
**ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
**tagcolorId** | **string** | A unique integer value identifying this tagcolor. | 

### Other Parameters

Other parameters are passed through a pointer to a apiRetrieveTagcolorRequest struct via the builder pattern
...
> Task RetrieveTask(ctx, taskId).Execute()
...
func main() {
    ...
    fmt.Fprintf(os.Stdout, "Response from `ApiApi.RetrieveTask`: %v\n", resp)
}
```
...
> Taskname RetrieveTaskname(ctx, tasknameId).Execute()
...
func main() {
    ...
    // response from `RetrieveTaskname`: Taskname
    fmt.Fprintf(os.Stdout, "Response from `ApiApi.RetrieveTaskname`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiRetrieveTasknameRequest struct via the builder pattern
...
> Taskpriority RetrieveTaskpriority(ctx, taskpriorityId).Execute()
...
func main() {
    ...
    // response from `RetrieveTaskpriority`: Taskpriority
    fmt.Fprintf(os.Stdout, "Response from `ApiApi.RetrieveTaskpriority`: %v\n", resp)
}
```
...
------------- | ------------- | ------------- | -------------
**ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
**taskpriorityId** | **string** | A unique integer value identifying this taskpriority. | 

### Other Parameters

Other parameters are passed through a pointer to a apiRetrieveTaskpriorityRequest struct via the builder pattern
...
> Taskstatus RetrieveTaskstatus(ctx, taskstatusId).Execute()
...
func main() {
    ...
    // response from `RetrieveTaskstatus`: Taskstatus
    fmt.Fprintf(os.Stdout, "Response from `ApiApi.RetrieveTaskstatus`: %v\n", resp)
}
```
...
------------- | ------------- | ------------- | -------------
**ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
**taskstatusId** | **string** | A unique integer value identifying this taskstatus. | 

### Other Parameters

Other parameters are passed through a pointer to a apiRetrieveTaskstatusRequest struct via the builder pattern
...
> Artifact UpdateArtifact(ctx, artifactId).Artifact(artifact).Execute()
...
func main() {
    ...
    fmt.Fprintf(os.Stdout, "Response from `ApiApi.UpdateArtifact`: %v\n", resp)
}
```
...
> Artifacttype UpdateArtifacttype(ctx, artifacttypeId).Artifacttype(artifacttype).Execute()
...
func main() {
    ...
    // response from `UpdateArtifacttype`: Artifacttype
    fmt.Fprintf(os.Stdout, "Response from `ApiApi.UpdateArtifacttype`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiUpdateArtifacttypeRequest struct via the builder pattern
...
> Case UpdateCase(ctx, caseId).Case_(case_).Execute()
...
func main() {
    ...
    // response from `UpdateCase`: Case
    fmt.Fprintf(os.Stdout, "Response from `ApiApi.UpdateCase`: %v\n", resp)
}
```
...
func main() {
    ...
    fmt.Fprintf(os.Stdout, "Response from `ApiApi.UpdateCompany`: %v\n", resp)
}
```
...
> Contact UpdateContact(ctx, contactId).Contact(contact).Execute()
...
func main() {
    ...
    fmt.Fprintf(os.Stdout, "Response from `ApiApi.UpdateContact`: %v\n", resp)
}
```
...
> Division UpdateDivision(ctx, divisionId).Division(division).Execute()
...
func main() {
    ...
    // response from `UpdateDivision`: Division
    fmt.Fprintf(os.Stdout, "Response from `ApiApi.UpdateDivision`: %v\n", resp)
}
```
...
> Dnsname UpdateDnsname(ctx, dnsnameId).Dnsname(dnsname).Execute()
...
func main() {
    ...
    // response from `UpdateDnsname`: Dnsname
    fmt.Fprintf(os.Stdout, "Response from `ApiApi.UpdateDnsname`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiUpdateDnsnameRequest struct via the builder pattern
...
func main() {
    ...
    fmt.Fprintf(os.Stdout, "Response from `ApiApi.UpdateDomain`: %v\n", resp)
}
```
...
> Domainuser UpdateDomainuser(ctx, domainuserId).Domainuser(domainuser).Execute()
...
func main() {
    ...
    // response from `UpdateDomainuser`: Domainuser
    fmt.Fprintf(os.Stdout, "Response from `ApiApi.UpdateDomainuser`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiUpdateDomainuserRequest struct via the builder pattern
...
func main() {
    ...
    fmt.Fprintf(os.Stdout, "Response from `ApiApi.UpdateIp`: %v\n", resp)
}
```
...
> Location UpdateLocation(ctx, locationId).Location(location).Execute()
...
func main() {
    ...
    fmt.Fprintf(os.Stdout, "Response from `ApiApi.UpdateLocation`: %v\n", resp)
}
```
...
> Os UpdateOs(ctx, osId).Os(os).Execute()
...
func main() {
    ...
    // response from `UpdateOs`: Os
    fmt.Fprintf(os.Stdout, "Response from `ApiApi.UpdateOs`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiUpdateOsRequest struct via the builder pattern
...
> Osarch UpdateOsarch(ctx, osarchId).Osarch(osarch).Execute()
...
func main() {
    ...
    // response from `UpdateOsarch`: Osarch
    fmt.Fprintf(os.Stdout, "Response from `ApiApi.UpdateOsarch`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiUpdateOsarchRequest struct via the builder pattern
...
> Reason UpdateReason(ctx, reasonId).Reason(reason).Execute()
...
func main() {
    ...
    fmt.Fprintf(os.Stdout, "Response from `ApiApi.UpdateReason`: %v\n", resp)
}
```
...
> Recommendation UpdateRecommendation(ctx, recommendationId).Recommendation(recommendation).Execute()
...
func main() {
    ...
    // response from `UpdateRecommendation`: Recommendation
    fmt.Fprintf(os.Stdout, "Response from `ApiApi.UpdateRecommendation`: %v\n", resp)
}
```
...
> Serviceprovider UpdateServiceprovider(ctx, serviceproviderId).Serviceprovider(serviceprovider).Execute()
...
func main() {
    ...
    // response from `UpdateServiceprovider`: Serviceprovider
    fmt.Fprintf(os.Stdout, "Response from `ApiApi.UpdateServiceprovider`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiUpdateServiceproviderRequest struct via the builder pattern
...
> System UpdateSystem(ctx, systemId).System(system).Execute()
...
func main() {
    ...
    // response from `UpdateSystem`: System
    fmt.Fprintf(os.Stdout, "Response from `ApiApi.UpdateSystem`: %v\n", resp)
}
```
...
> Systemtype UpdateSystemtype(ctx, systemtypeId).Systemtype(systemtype).Execute()
...
func main() {
    ...
    // response from `UpdateSystemtype`: Systemtype
    fmt.Fprintf(os.Stdout, "Response from `ApiApi.UpdateSystemtype`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiUpdateSystemtypeRequest struct via the builder pattern
...
> Systemuser UpdateSystemuser(ctx, systemuserId).Systemuser(systemuser).Execute()
...
func main() {
    ...
    // response from `UpdateSystemuser`: Systemuser
    fmt.Fprintf(os.Stdout, "Response from `ApiApi.UpdateSystemuser`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiUpdateSystemuserRequest struct via the builder pattern
...
> Tag UpdateTag(ctx, tagId).Tag(tag).Execute()
...
func main() {
    ...
    fmt.Fprintf(os.Stdout, "Response from `ApiApi.UpdateTag`: %v\n", resp)
}
```
...
func main() {
    ...
    fmt.Fprintf(os.Stdout, "Response from `ApiApi.UpdateTask`: %v\n", resp)
}
```
...
> Taskname UpdateTaskname(ctx, tasknameId).Taskname(taskname).Execute()
...
func main() {
    ...
    // response from `UpdateTaskname`: Taskname
    fmt.Fprintf(os.Stdout, "Response from `ApiApi.UpdateTaskname`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiUpdateTasknameRequest struct via the builder pattern
